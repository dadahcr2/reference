...
**City** | **`280m`:** **Watery Tunnel** (Cup of City Water r-4R) , **`310m`:** **Don't Dive** (Cup of City Water r-4R) , **`340m`:** **Downtown Madness** (Travel Cup r-4L) , **`345m`:** **Danger Zone** (Capital Cup r9M) , **`400m`:** **Drive Through** (Capital Cup r9M) ,  **Get Soaked** (Cup of City Water r-4R) , **`420m`:** **Hot Tarmac** (Bill's Circuit r-7R) ,  **The Carousel** (Bill's Circuit r-7R) ,  **Smooth Curves** (Finger GP r11R) , **`485m`:** **A Bridge Too Far** (Capital Cup r9M) , **`500m`:** **Breaking Bad** (Finger GP r11R) ,  **Hairpin** (Finger GP r11R) , **`520m`:** **Whipclash** (Spring City r6L) , **`530m`:** **Fast Lane** (Bill's Circuit r-7R) , **`550m`:** **Fury Road** (Spring City r6L) , **`600m`:** **Rubberist** (Spring City r6L) , **`650m`:** **Heat Club** (Spring City r6L) , **`1000m`:** **Forgotten Highway**
...
**Glacier** | **`410m`:** **Tailwind Trail** (Stormrider Cup r12R) ,  **Headwind Shortcut** (Stormrider Cup r12R) , **`493m`:** **Like a Hawk** (Stormrider Cup r12R) , **`500m`:** **Bone Gorge** (Glacier Cup r-8L) , **`520m`:** **Boiling Hollow** (Glacier Cup r-8L) , **`1000m`:** **Frostfire Caverns**
