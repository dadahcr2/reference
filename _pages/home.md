...
![Rally] | ![Wi]![WT]![CB]<br>🦘 | ![Wi]{: style="background-color:yellow" }![LB]{: style="background-color:yellow" }![CB]{: style="background-color:yellow" }^<br>🦘 | ![WT]{: style="background-color:yellow" }![Wi]{: style="background-color:yellow" }![CB]{: style="background-color:yellow" }^ /![JS]/![Ma] | ![WT]{: style="background-color:yellow" }![CB]{: style="background-color:yellow" }![Wi]{: style="background-color:yellow" }^<br>![WT]![CB]![WB] | ![Rally] | ![LB]![CB]![Fume]<br>🦘 | ![WT]![Wi]![CB]^{: style="background-color:yellow" } | ![LB]![Wi]![WT]<br>🦘{: style="background-color:yellow" }^ | ![OT]![Wi]![CB] | ![Rally] | ![OT]![Fume]![CB]^<br>🦘 | 🦘 | 🦘^  | 🦘^  | ![Rally] | 🦘^  | ![JS]![Wi]![WT]<br>🦘^  | ![JS]![Wi]![WT]^  | ![CB]![Wi]![WT]^ | ![Rally]  
...
<mark>Best Vehicle^</mark>, \*=Remove, 🦘 =(![JS]![LB]![Wi]), Br=Brain, DF=Downforce, Dr=Drag, SW=SkiWax  - Sources: Map Rankings, Zorro (HCR2 Adventure Setup Server), NikoRei (Adventure Guide Server), BaDAtHcR - Latest version on www.hcr2.info
