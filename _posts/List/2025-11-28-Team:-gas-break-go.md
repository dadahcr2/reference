...
We are an open team, so no password.  If there is a spot available and the below resonates with you, you are very welcome to join (10000+GP) - or feel free to join our even more relaxed team: **Gas Brake Go²** (Note: **Gas Brake Go²** currently on a break).
...
3. **In-game chat** is the primary means of communication. Nevertheless, we also have a well-maintained [discord server](https://discord.gg/4CrgMxC2YE) and website: <https://reference.hcr2info.com>.
